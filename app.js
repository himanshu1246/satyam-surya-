...
window.addEventListener("load", (event) => {
  // Lazyload
  // const urlAdParamsCheck = new URLSearchParams(window.location.search);
  // const hasAdSourceCheck = urlAdParamsCheck.has("source_key");
  // const hasAdMediumCheck = urlAdParamsCheck.has("utm_medium");
  // if (hasAdSourceCheck || hasAdMediumCheck) {
  lazySizes.init();
  // } else {
  //   setTimeout(() => {
  //     lazySizes.init();
